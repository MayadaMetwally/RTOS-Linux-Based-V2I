...
osThreadId UltrasonicFrontHandle;
...
/* USER CODE BEGIN Header_UltrasonicFront_Task */
/**
* @brief Function implementing the Ultrasonic_Fron thread.
* @param argument: Not used
* @retval None
*/
...
void UltrasonicFront_Task(void const * argument)
{
  ...
  /* USER CODE END UltrasonicFront_Task */
}
